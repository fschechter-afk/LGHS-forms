...
-- ---------------------------------------------------------------- rpc: group membership
-- Who may change membership: the group's creator, plus staff and admins.
-- Deliberately not "any member" — a student should not be able to pull an
-- outsider into a school conversation. Anyone can leave on their own.
